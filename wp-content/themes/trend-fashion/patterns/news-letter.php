...
/**
 * Title: News Letter
 * Slug: trend-fashion/news-letter
...
<h2 class="wp-block-heading"><?php echo esc_html__( 'Join our newsletter for $10 offs', 'trend-fashion' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php echo esc_html__( 'Register now to get latest updates on promotions &amp; coupons.', 'trend-fashion' ); ?> </p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:search {"label":"Search","showLabel":false,"placeholder":"Enter Your Email","width":100,"widthUnit":"%","buttonText":"Search","buttonUseIcon":true,"style":{"typography":{"fontSize":"14px"}}} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->