 ...
 */
class trend_fashion_Admin_Info {
    /**
    ...
    public function add_menu() {
        add_theme_page(
            esc_html__('Trend Fashion Theme', 'trend-fashion'),
            esc_html__('Trend Fashion Theme', 'trend-fashion'),
            'edit_theme_options',
            'trend-fashion',
    ...
    public function check_rt_easy_builder_freemius() {
        if ( function_exists( 'RT_Easy_Builder\rt_freemius' ) && ! RT_Easy_Builder\rt_freemius()->is_not_paying() ) {
            ...
            add_action( 'wp_ajax_dismiss_trend_fashion_notification', array( $this, 'dismiss_notification_ajax_handler' ) );
        }
    }
    ...
    public function reset_notification_dismissal() {
        delete_transient('trend_fashion_notification_dismissed');
    }
    ...
    public function compatible_check() {
        ...
        $dismissed = get_option('trend_fashion_notification_dismissed');
        if (!$dismissed) {
    ...
    public function dismiss_notification() {
        ...
        update_option('trend_fashion_notification_dismissed', true);
    }
            ...
            (function($) {
                $(document).on('click', '.notice.is-dismissible .notice-dismiss', function() {
                    $.ajax({
                        ...
                        type: 'POST',
                        data: {
                            action: 'dismiss_trend_fashion_notification',
...
// Instantiate the Trend Fashion Admin Info class
new trend_fashion_Admin_Info();